...
#
# Generated by export_simulation on Wed Aug 14 16:49:51 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_3.sh' script.

./clk_wiz_3.sh -reset_run
...
./clk_wiz_3.sh -noclean_files

For more information on the script, please type './clk_wiz_3.sh -help'.
